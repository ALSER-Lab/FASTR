...
def parse_metadata_header(
    ...
    Returns: (metadata_blocks, data_start_byte, sra_accession, phred_alphabet_max,
              detected_mode, length_flag, second_head_flag, safe_mode_flag, grayscale_vals)
    """
    metadata_blocks = []
    sra_accession = None
    length_flag = False
