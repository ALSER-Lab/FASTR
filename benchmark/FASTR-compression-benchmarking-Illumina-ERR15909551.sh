...
sbatch -p mi2101x -N 1 -n 16 -t 12:00:00 -o "/work1/malser/mohammedalser/illumina-ERR15909551-results/fastr_mode0-stats-command-out.txt" --wrap="\time -v --output "/work1/malser/mohammedalser/illumina-ERR15909551-results/fastr_mode0-stats-time-memory.txt" python /work1/malser/mohammedalser/FASTR-main/src/toFASTR.py /work1/malser/mohammedalser/ERR15909551.fastq /work1/malser/mohammedalser/illumina-ERR15909551-results/ERR15909551.fastr_mode0.fastr --mode 0 --qual_scale log --seq_type illumina_sra --workers 16 --phred_alpha phred94"


#FASTR Mode 1 COMPRESSION
sbatch -p mi2101x -N 1 -n 16 -t 12:00:00 -o "/work1/malser/mohammedalser/illumina-ERR15909551-results/fastr_mode1-stats-command-out.txt" --wrap="\time -v --output "/work1/malser/mohammedalser/illumina-ERR15909551-results/fastr_mode1-stats-time-memory.txt" python /work1/malser/mohammedalser/FASTR-main/src/toFASTR.py /work1/malser/mohammedalser/ERR15909551.fastq /work1/malser/mohammedalser/illumina-ERR15909551-results/ERR15909551.fastr_mode1.fastr --mode 1 --qual_scale log --seq_type illumina_sra --workers 16 --phred_alpha phred94"

#FASTR Mode 2 COMPRESSION
sbatch -p mi2101x -N 1 -n 16 -t 12:00:00 -o "/work1/malser/mohammedalser/illumina-ERR15909551-results/fastr_mode2-stats-command-out.txt" --wrap="\time -v --output "/work1/malser/mohammedalser/illumina-ERR15909551-results/fastr_mode2-stats-time-memory.txt" python /work1/malser/mohammedalser/FASTR-main/src/toFASTR.py /work1/malser/mohammedalser/ERR15909551.fastq /work1/malser/mohammedalser/illumina-ERR15909551-results/ERR15909551.fastr_mode2.fastr --mode 2 --qual_scale log --seq_type illumina_sra --workers 16 --phred_alpha phred94"


#FASTR Mode 3 COMPRESSION
sbatch -p mi2101x -N 1 -n 16 -t 12:00:00 -o "/work1/malser/mohammedalser/illumina-ERR15909551-results/fastr_mode3-stats-command-out.txt" --wrap="\time -v --output "/work1/malser/mohammedalser/illumina-ERR15909551-results/fastr_mode3-stats-time-memory.txt" python /work1/malser/mohammedalser/FASTR-main/src/toFASTR.py /work1/malser/mohammedalser/ERR15909551.fastq /work1/malser/mohammedalser/illumina-ERR15909551-results/ERR15909551.fastr_mode3.fastr --mode 3 --qual_scale log --seq_type illumina_sra --workers 16 --phred_alpha phred94"
